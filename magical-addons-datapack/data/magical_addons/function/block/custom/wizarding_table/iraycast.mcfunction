...
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/block/interact/wizarding_table=true}] run function magical_addons:block/custom/wizarding_table/iscan"
