# block:custom/wizarding_table/gui/recipe_book_category1
# called by: block:custom/wizarding_table/update_gui

## Exit
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:2b}]} run return run function magical_addons:block/custom/wizarding_table/gui/recipe_book/close_category1
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:3b}]} run return run function magical_addons:block/custom/wizarding_table/gui/recipe_book/open_category2
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:11b}]} run return run function magical_addons:block/custom/wizarding_table/gui/recipe_book/open_category3
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:12b}]} run return run function magical_addons:block/custom/wizarding_table/gui/recipe_book/open_category4
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:20b}]} run return run function magical_addons:block/custom/wizarding_table/gui/recipe_book/open_category5
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:21b}]} run return run function magical_addons:block/custom/wizarding_table/gui/recipe_book/open_category6

## Sounds
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:8b}]} unless score @s maddons.wizarding_table_page matches ..0 run playsound ui.button.click ui @p ~ ~ ~ .3
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:26b}]} unless score @s maddons.wizarding_table_page matches 2.. run playsound ui.button.click ui @p ~ ~ ~ .3

## Scroll
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:8b}]} unless score @s maddons.wizarding_table_page matches ..0 run scoreboard players remove @s maddons.wizarding_table_page 1
execute if entity @s[tag=maddons.block.rb.c1_] unless data block ~ ~ ~ {Items:[{Slot:26b}]} unless score @s maddons.wizarding_table_page matches 2.. run scoreboard players add @s maddons.wizarding_table_page 1
...
## Category pages
execute if score @s maddons.wizarding_table_page matches 0 run item replace block ~ ~ ~ container.0 with structure_void[max_stack_size=1,max_damage=100,item_model="magical_addons:gui/wizarding_table",custom_model_data={strings:["wt_rb_cg1_s2"]},custom_data={magical_addons:{gui:1}},tooltip_display={hide_tooltip:true}]
execute if score @s maddons.wizarding_table_page matches 1 run item replace block ~ ~ ~ container.0 with structure_void[max_stack_size=1,max_damage=100,item_model="magical_addons:gui/wizarding_table",custom_model_data={strings:["wt_rb_cg1_s0"]},custom_data={magical_addons:{gui:1}},tooltip_display={hide_tooltip:true}]
execute if score @s maddons.wizarding_table_page matches 2 run item replace block ~ ~ ~ container.0 with structure_void[max_stack_size=1,max_damage=100,item_model="magical_addons:gui/wizarding_table",custom_model_data={strings:["wt_rb_cg1_s1"]},custom_data={magical_addons:{gui:1}},tooltip_display={hide_tooltip:true}]
...
tag @s add maddons.block.rb.c1_