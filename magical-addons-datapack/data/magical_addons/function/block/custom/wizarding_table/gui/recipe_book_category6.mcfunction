...
## Recipes
execute if score @s maddons.wizarding_table_page matches 0 run function magical_addons:block/custom/wizarding_table/gui/recipe_book/recipe/gravitite_helmet
execute if score @s maddons.wizarding_table_page matches 1 run function magical_addons:block/custom/wizarding_table/gui/recipe_book/recipe/gravitite_chestplate
execute if score @s maddons.wizarding_table_page matches 2 run function magical_addons:block/custom/wizarding_table/gui/recipe_book/recipe/gravitite_leggings
execute if score @s maddons.wizarding_table_page matches 3 run function magical_addons:block/custom/wizarding_table/gui/recipe_book/recipe/gravitite_boots
