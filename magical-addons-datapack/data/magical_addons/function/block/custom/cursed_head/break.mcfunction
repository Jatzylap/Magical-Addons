...
execute if entity @s[type=!player] run loot spawn ~ ~ ~ loot magical_addons:cursed_head
execute if entity @s[type=player,gamemode=!creative] run loot spawn ~ ~ ~ loot magical_addons:blocks/cursed_head
