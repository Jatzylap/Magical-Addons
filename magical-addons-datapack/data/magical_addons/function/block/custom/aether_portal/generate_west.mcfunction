...
## Part: foot
summon item_display ~ ~ ~ {data:{magical_addons:{id:"aether_portal",face:"west",part:"foot",break_cmd:"execute unless block ~ ~ ~ #magical_addons:aether_portal[facing=west,part=foot] run function magical_addons:block/custom/aether_portal/break"}},item:{id:"trial_spawner",components:{"minecraft:item_model":"air"}},Tags:[maddons.block,maddons.aether_portal,maddons.invul,maddons.block.face_west,maddons.block.part_foot]}
