...
execute if score #magical_addons:aether_portal maddons.temp matches 1 run setblock ~ ~ ~ white_bed[facing=west,part=foot]
...
execute if score #magical_addons:aether_portal maddons.temp matches 1 run setblock ~-1 ~ ~ white_bed[facing=west,part=head]
