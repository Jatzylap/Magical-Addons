...
## Part: head
execute positioned ~ ~ ~-1 summon item_display run data merge entity @s {data:{magical_addons:{id:"aether_portal",face:"north",part:"head",break_cmd:"execute unless block ~ ~ ~ #magical_addons:aether_portal[facing=north,part=head] run function magical_addons:block/custom/aether_portal/break"}},transformation:{translation:[0.0,0.005,0.0],scale:[1.001,1.001,1.001]},Rotation:[0f],item:{id:"white_bed",components:{"minecraft:enchantments":{"magical_addons:lucidity":1}}},view_range:64,Tags:[maddons.block,maddons.aether_portal,maddons.invul,maddons.block.face_north,maddons.block.part_head]}
execute unless block ~ ~ ~ #magical_addons:aether_portal run setblock ~ ~ ~ white_bed[facing=north,part=head]
