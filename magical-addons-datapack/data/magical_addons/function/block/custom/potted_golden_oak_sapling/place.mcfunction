...
## Block
summon block_display ~ ~ ~ {block_state:{Name:"flower_pot"},data:{magical_addons:{id:"potted_golden_oak_sapling",break_cmd:"execute unless block ~ ~ ~ structure_void run function magical_addons:block/custom/potted_golden_oak_sapling/break"}},Passengers:[{id:item_display,item:{id:"trial_spawner",components:{"minecraft:item_model":"magical_addons:golden_oak_sapling","minecraft:custom_model_data":{strings:["block"]}}},view_range:64}],Tags:[maddons.block,maddons.potted_golden_oak_sapling]}
