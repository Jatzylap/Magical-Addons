# magical_addons:entity/sculk_spider/hit
# called by advancement: magical_addons:player/hit_sculk_spider
...
advancement revoke @s only magical_addons:---/player/hit_sculk_spider