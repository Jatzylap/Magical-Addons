...
execute if score @s maddons.cooldown matches 20..221 on vehicle on vehicle at @s if data storage magical_addons:tick {data:{entity:{automaton:{animations:{run:{frame:0}}}}}} run playsound magical_addons:entity.automaton.short_punch hostile @a ~ ~ ~ 3 1.1
execute if score @s maddons.cooldown matches 20..221 on vehicle on vehicle at @s if data storage magical_addons:tick {data:{entity:{automaton:{animations:{run:{frame:8}}}}}} run playsound magical_addons:entity.automaton.short_punch hostile @a ~ ~ ~ 3 1.1
