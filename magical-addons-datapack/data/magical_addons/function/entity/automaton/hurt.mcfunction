...
execute if score @s[tag=!maddons.entity.death] maddons.hurt matches 9 on vehicle on passengers as @s[tag=!maddons.bone.torso,tag=!maddons.bone.head] run data merge entity @s {start_interpolation:-1,interpolation_duration:2,transformation:{left_rotation:[0.195,0.,0.,0.981]}}
execute if score @s[tag=!maddons.entity.death] maddons.hurt matches 7 on vehicle on passengers as @s[tag=!maddons.bone.torso,tag=!maddons.bone.head] run data merge entity @s {start_interpolation:-1,interpolation_duration:2,transformation:{left_rotation:[0.,0.,0.,1.]}}
