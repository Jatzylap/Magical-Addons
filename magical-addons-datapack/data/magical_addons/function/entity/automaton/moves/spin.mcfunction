# magical_addons:entity/automaton/moves/spin
...
execute on vehicle on passengers run item modify entity @s[tag=!maddons.bone.legs] contents magical_addons:entity/animate/automaton/attack
