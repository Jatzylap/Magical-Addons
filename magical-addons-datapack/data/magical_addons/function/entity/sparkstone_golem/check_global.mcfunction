...
## Hop ambient
execute if predicate magical_addons:shared/25_percent unless entity @p[distance=..32,tag=!maddons.invul] unless block ~ ~-0.5 ~ #magical_addons:non_collidable run return run function magical_addons:dev/set_motion_vector {power:1.0}
