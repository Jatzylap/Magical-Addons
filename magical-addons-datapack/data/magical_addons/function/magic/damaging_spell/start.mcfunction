...
execute anchored eyes run summon item_display ^ ^ ^ {data:{magical_addons:{tick_cmd:"function magical_addons:magic/damaging_spell/loop"}},CustomName:{"translate":"enchantment.magical_addons.damaging_spell"},item_display:"head",brightness:{sky:15,block:15},teleport_duration:3,billboard:"center",item:{id:spawner,components:{custom_model_data:{colors:[[0.5,0.0,1.0]]},item_model:"magical_addons:particle/spell"}},Tags:[maddons.invul,maddons.damaging_spell,maddons.magic,maddons.entity.tickable]}
