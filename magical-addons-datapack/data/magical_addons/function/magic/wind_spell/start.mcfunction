...
execute anchored eyes run summon item_display ^ ^ ^ {data:{magical_addons:{tick_cmd:"function magical_addons:magic/wind_spell/loop"}},CustomName:{"translate":"enchantment.magical_addons.wind_spell"},item_display:"head",brightness:{sky:15,block:15},teleport_duration:3,billboard:"center",item:{id:spawner,components:{custom_model_data:{colors:[I;16777215]},item_model:"magical_addons:particle/spell"}},Tags:[maddons.invul,maddons.wind_spell,maddons.magic,maddons.entity.tickable]}
