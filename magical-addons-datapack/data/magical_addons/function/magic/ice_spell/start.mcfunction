...
execute anchored eyes run summon item_display ^ ^ ^ {data:{magical_addons:{tick_cmd:"function magical_addons:magic/ice_spell/loop"}},CustomName:{"translate":"enchantment.magical_addons.ice_spell"},item_display:"head",brightness:{sky:15,block:15},teleport_duration:3,billboard:"center",item:{id:spawner,components:{custom_model_data:{colors:[[0,1,1]]},item_model:"magical_addons:particle/spell"}},Tags:[maddons.invul,maddons.ice_spell,maddons.magic,maddons.entity.tickable]}
