...
# called by advancement: shared:place_gravitite

data modify storage bs:data raycast.entities set value 0b
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/shared/place_gravitite=true}] run function magical_addons:item/gravitite/debug/scan"
