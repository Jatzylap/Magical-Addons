...
execute on passengers run data merge entity @s {Tags:[maddons.entity,maddons.wooden_dagger,maddons.invul,maddons.entity.tickable],data:{magical_addons:{tick_cmd:"function magical_addons:item/wooden_dagger/loop"}},view_range:300f,teleport_duration:3,transformation:{left_rotation:[0.0f,0.707f,0.0f,0.707f],right_rotation:[0.0f,0.0f,0.353f,0.935f]}}
