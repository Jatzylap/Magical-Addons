# dimension:overworld/load_chunk/-16_-16_0
...
execute store result storage magical_addons:temp data.dimension.z int 1 run scoreboard players operation #maddons.chunk_ maddons.z += #0 maddons.constant
