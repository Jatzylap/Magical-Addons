$data modify storage magical_addons:dev data.cycle_display_rotation.axis set value "$(axis)"
$data modify storage magical_addons:dev data.cycle_display_rotation.angle set value $(angle)f
...
data remove storage magical_addons:dev data.cycle_display_rotation.axis
data remove storage magical_addons:dev data.cycle_display_rotation.angle
