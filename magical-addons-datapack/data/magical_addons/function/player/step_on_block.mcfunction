...
## Skip
execute if score @s maddons.jump matches 1.. store result score @s maddons.sprint_ if score @s maddons.walk_ matches 1.. run scoreboard players set @s maddons.walk_ 160
execute if score @s maddons.jump matches 1.. store result score @s maddons.sprint_ if score @s maddons.sprint_ matches 1.. run scoreboard players set @s maddons.walk_ 160
...
execute if score @s maddons.fall matches 500.. run function magical_addons:entity/land with block ~ ~-1 ~ components."minecraft:custom_data".magical_addons

## Reset
scoreboard players reset @s maddons.walk
scoreboard players reset @s maddons.sprint
scoreboard players reset @s maddons.jump
scoreboard players reset @s maddons.fall