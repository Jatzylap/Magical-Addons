...
## Play track
execute if entity @e[limit=1,tag=maddons.entity,tag=maddons.automaton,tag=maddons.phase1] run playsound magical_addons:music.boss.phase1 master @s ~ ~ ~
execute if entity @e[limit=1,tag=maddons.entity,tag=maddons.automaton,tag=maddons.phase2] run playsound magical_addons:music.boss.phase2 master @s ~ ~ ~
execute if entity @e[limit=1,tag=maddons.entity,tag=maddons.automaton,tag=maddons.phase3] run playsound magical_addons:music.boss.phase3 master @s ~ ~ ~
