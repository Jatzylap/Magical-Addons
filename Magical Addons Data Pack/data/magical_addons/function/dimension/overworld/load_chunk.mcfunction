...
$execute unless data storage magical_addons:overworld {data:{chunks:[{x:$(x),y:$(y),z:$(z)}]}} run return run data modify storage magical_addons:overworld data.chunks append value {x:$(x),y:$(y),z:$(z)}
