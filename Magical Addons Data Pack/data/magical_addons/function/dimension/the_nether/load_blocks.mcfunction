# dimension:the_nether/load_blocks
# called by: dimension:the_nether/load_chunk

## Spawner
execute in magical_addons:---/the_nether run forceload add ~ ~
clone from the_nether ~ ~ ~ ~15 ~15 ~15 to magical_addons:---/the_nether ~ ~ ~ filtered minecraft:spawner
...
fill ~ ~ ~ ~15 ~15 ~15 oak_planks replace oak_slab[type=double]
