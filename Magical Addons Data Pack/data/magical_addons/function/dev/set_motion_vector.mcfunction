...
$execute anchored feet run summon marker ^ ^ ^$(power) {Tags:[maddons.set_motion_vector]}

execute store result score @s maddons.x2 run data get entity @n[type=marker,tag=maddons.set_motion_vector] Pos[0] 1000
execute store result score @s maddons.y2 run data get entity @n[type=marker,tag=maddons.set_motion_vector] Pos[1] 1000
execute store result score @s maddons.z2 run data get entity @n[type=marker,tag=maddons.set_motion_vector] Pos[2] 1000
...
kill @e[type=marker,tag=maddons.set_motion_vector]