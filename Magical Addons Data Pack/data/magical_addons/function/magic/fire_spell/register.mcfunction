# magic:fire_spell/register
# called by: magic:fire_spell/start
...
function magical_addons:dev/register_entity {tick_cmd:"function magical_addons:magic/fire_spell/loop"}
