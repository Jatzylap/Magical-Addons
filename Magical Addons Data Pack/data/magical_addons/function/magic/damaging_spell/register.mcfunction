# magic:damaging_spell/register
# called by: magic:damaging_spell/start
...
function magical_addons:dev/register_entity {tick_cmd:"function magical_addons:magic/damaging_spell/loop"}
