# magic:wind_spell/register
# called by: magic:wind_spell/start
...
function magical_addons:dev/register_entity {tick_cmd:"function magical_addons:magic/wind_spell/loop"}
