...
execute as @n[tag=maddons.diamond_dagger] run function magical_addons:dev/register_entity {id:"diamond_dagger",cmd:"function magical_addons:item/diamond_dagger/loop"}
