...
execute as @n[tag=maddons.netherite_dagger] run function magical_addons:dev/register_entity {id:"netherite_dagger",cmd:"function magical_addons:item/netherite_dagger/loop"}
