...
execute as @n[tag=maddons.stone_dagger] run function magical_addons:dev/register_entity {id:"stone_dagger",cmd:"function magical_addons:item/stone_dagger/loop"}
