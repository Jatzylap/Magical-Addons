...
## Start countdown
execute if score @s maddons.portal_time_check matches 1 if entity @n[type=item_display,tag=maddons.aether_portal,distance=..1.6] run scoreboard players add @s maddons.portal_time 1
...
execute if score @s maddons.portal_time matches 1.. in the_aether run forceload add ~-6 ~-6 ~6 ~6
...
## Warp to Sky
execute unless dimension the_aether if score @s maddons.portal_time_check matches 1 if score @s maddons.portal_time matches 4 run function magical_addons:dungeon/aether_portal/warp

## Return from Sky
execute if dimension the_aether if score @s maddons.portal_time_check matches 1 if score @s maddons.portal_time matches 4 run function magical_addons:dungeon/aether_portal/return