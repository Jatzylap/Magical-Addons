...
## Translation Y
execute if entity @s[tag=!maddons.ceiling] on passengers store result entity @s[tag=maddons.head] transformation.translation[1] float .0001 on vehicle store result entity @s[tag=maddons.body] transformation.translation[1] float .0001 on vehicle run data get entity @s[tag=maddons.vehicle] attributes[{id:"minecraft:scale"}].base 1000
execute if entity @s[tag=maddons.ceiling] on passengers store result entity @s[tag=maddons.head] transformation.translation[1] float -.0001 on vehicle store result entity @s[tag=maddons.body] transformation.translation[1] float -.0001 on vehicle run data get entity @s[tag=maddons.vehicle] attributes[{id:"minecraft:scale"}].base 1000
