...
tag @s[tag=!maddons.side_right] add maddons.flip

## Ceiling
execute if entity @s[tag=maddons.flip,tag=maddons.ceiling] run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 4f
execute if entity @s[tag=maddons.flip,tag=maddons.ceiling] on passengers as @s[tag=maddons.head] run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 3f

## Ground, up, down
execute if entity @s[tag=maddons.flip,tag=!maddons.ceiling,tag=!maddons.side_right,tag=!maddons.side_left] run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 4f
execute if entity @s[tag=maddons.flip,tag=!maddons.ceiling,tag=!maddons.side_right,tag=!maddons.side_left] on passengers as @s[tag=maddons.head] run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 3f

## Side left
execute if entity @s[tag=maddons.flip,tag=maddons.side_left] run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 4f
execute if entity @s[tag=maddons.flip,tag=maddons.side_left] on passengers as @s[tag=maddons.head] run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 3f
