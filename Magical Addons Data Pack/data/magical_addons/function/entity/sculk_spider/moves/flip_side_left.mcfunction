...
execute if entity @s[tag=!maddons.side_left] on vehicle run data merge entity @s {NoGravity:1b}
...
data modify entity @s item.components."minecraft:custom_data".magical_addons.angle set value "side_left"
execute on passengers as @s[tag=maddons.head] run data modify entity @s item.components."minecraft:custom_data".magical_addons.angle set value "side_left"
