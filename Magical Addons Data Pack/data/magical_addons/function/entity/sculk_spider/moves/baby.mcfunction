...
function magical_addons:entity/sculk_spider/summon {nbt:{Tags:[maddons.baby,maddons.vehicle,maddons.sculk_spider,maddons.custom_step_sound],attributes:[{id:scale,base:0.65}]}}
