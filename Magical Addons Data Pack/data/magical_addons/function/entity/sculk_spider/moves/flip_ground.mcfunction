...
execute if entity @s[tag=!maddons.ground] on vehicle run data merge entity @s {NoGravity:0b}
execute if entity @s[tag=!maddons.ground] on vehicle run attribute @s minecraft:movement_speed base set 0.35
