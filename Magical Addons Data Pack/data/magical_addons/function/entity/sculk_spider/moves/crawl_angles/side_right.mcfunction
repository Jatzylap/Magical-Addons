...
execute if entity @s[tag=!maddons.side_right] on vehicle on passengers run data merge entity @s[tag=maddons.part] {start_interpolation:-1,interpolation_duration:20,transformation:{translation:[0f,0.5f,0f],left_rotation:[0f,1f,0f,0f]}}
