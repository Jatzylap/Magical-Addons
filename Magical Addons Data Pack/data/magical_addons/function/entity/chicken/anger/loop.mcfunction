...
execute if score @s maddons.chicken.anger matches 1.. positioned ^ ^ ^.5 as @a[distance=..1] at @s run damage @s 1.5 mob_attack by @n[type=chicken,tag=maddons.chicken.anger]
