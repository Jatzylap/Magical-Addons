...
## Angle
execute on vehicle unless block ~ ~.5 ~ #magical_addons:non_collidable if block ~ ~-.5 ~ #magical_addons:non_collidable on passengers as @s[tag=maddons.entity] at @s run function magical_addons:entity/flying_cow/moves/crawl_angles/ceiling
execute on vehicle unless block ^.6 ^ ^ #magical_addons:non_collidable if block ^-.6 ^ ^ #magical_addons:non_collidable if block ^ ^ ^1 #magical_addons:non_collidable if block ^ ^ ^-1 #magical_addons:non_collidable on passengers as @s[tag=maddons.entity] at @s run function magical_addons:entity/flying_cow/moves/crawl_angles/side_left
execute on vehicle unless block ^-.6 ^ ^ #magical_addons:non_collidable if block ^.6 ^ ^ #magical_addons:non_collidable if block ^ ^ ^1 #magical_addons:non_collidable if block ^ ^ ^-1 #magical_addons:non_collidable on passengers as @s[tag=maddons.entity] at @s run function magical_addons:entity/flying_cow/moves/crawl_angles/side_right
...
execute on vehicle if block ~ ~.5 ~ #magical_addons:non_collidable if block ~ ~-.5 ~ #magical_addons:non_collidable unless block ^ ^ ^-1 #magical_addons:non_collidable if block ^ ^ ^1 #magical_addons:non_collidable on passengers as @s[tag=maddons.entity] at @s run function magical_addons:entity/flying_cow/moves/crawl_angles/side_down
execute on vehicle if block ~ ~.5 ~ #magical_addons:non_collidable unless block ~ ~-.5 ~ #magical_addons:non_collidable on passengers as @s[tag=maddons.entity] at @s run function magical_addons:entity/flying_cow/moves/crawl_angles/ground
...
## Despawn
execute at @s[tag=!maddons.death] unless predicate magical_addons:shared/riding_vehicle run function magical_addons:entity/kill