...
## Set cooldown frame
execute store result score #maddons.temp maddons.temp run scoreboard players set @s maddons.cooldown 90

## Set animation
execute on passengers run data modify entity @s[tag=maddons.head] item.components."minecraft:custom_model_data".floats[1] set value 12f
data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 12f
data modify entity @s item.components."minecraft:custom_data".magical_addons merge value {attack:"crush"}
...
scoreboard players remove @s maddons.animation 89
...
execute on passengers run data modify entity @s[tag=maddons.head] item.components."minecraft:custom_model_data".colors set from entity @s item.components."minecraft:custom_data".magical_addons.colors
