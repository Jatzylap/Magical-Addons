...
## Set animation
data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 9f
data modify entity @s item.components."minecraft:custom_data".magical_addons merge value {attack:"kick1"}
