...
## Move
execute unless score @s maddons.cooldown matches 0.. store success entity @s item.components."minecraft:custom_model_data".floats[1] float 1 run data modify entity @s data.magical_addons.pos set from entity @s Pos
...
## Animate
execute if score @s maddons.cooldown matches 0.. run function magical_addons:entity/automaton/animate with entity @s data.magical_addons