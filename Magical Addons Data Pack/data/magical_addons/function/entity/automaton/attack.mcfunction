...
## Attacks (phase 3)
execute if entity @s[tag=maddons.phase3] store result score @s[tag=maddons.phase3] maddons.temp run random value 0..8
execute if score @s maddons.temp matches 0 on vehicle at @s on passengers as @s[tag=maddons.entity] at @s run return run function magical_addons:entity/automaton/moves/shoot
...
execute if score @s maddons.temp matches 4 on vehicle at @s if entity @n[tag=!maddons.automaton,tag=!maddons.invul,type=!#magical_addons:invulnerable,distance=..5] on passengers as @s[tag=maddons.entity] at @s run return run function magical_addons:entity/automaton/moves/punch3
execute if score @s maddons.temp matches 5 on vehicle at @s if entity @n[tag=!maddons.automaton,tag=!maddons.invul,type=!#magical_addons:invulnerable,distance=..5] on passengers as @s[tag=maddons.entity] at @s run return run function magical_addons:entity/automaton/moves/kick1
execute if score @s maddons.temp matches 6 on vehicle at @s if entity @n[tag=!maddons.automaton,tag=!maddons.invul,type=!#magical_addons:invulnerable,distance=..5] on passengers as @s[tag=maddons.entity] at @s run return run function magical_addons:entity/automaton/moves/kick2
execute if score @s maddons.temp matches 7 on vehicle at @s if entity @n[tag=!maddons.automaton,tag=!maddons.invul,type=!#magical_addons:invulnerable,distance=..8] on passengers as @s[tag=maddons.entity] at @s run return run function magical_addons:entity/automaton/moves/crush
execute if score @s maddons.temp matches 8 on vehicle at @s run return run function magical_addons:entity/automaton/moves/spin