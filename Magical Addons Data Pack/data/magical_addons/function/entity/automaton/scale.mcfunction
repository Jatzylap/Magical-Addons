...
## Scale
execute on passengers store result entity @s[tag=maddons.head] item.components."minecraft:custom_data".magical_addons.colors[0][1] double .00006275 on vehicle store result entity @s[tag=maddons.body] item.components."minecraft:custom_data".magical_addons.colors[0][1] double .00006275 on vehicle run data get entity @s[tag=maddons.vehicle] attributes[{id:"minecraft:scale"}].base 1000
...
## Translation Y
execute on passengers store result entity @s[tag=maddons.head] transformation.translation[1] float -.002075 on vehicle store result entity @s[tag=maddons.body] transformation.translation[1] float -.002075 on vehicle run data get entity @s[tag=maddons.vehicle] attributes[{id:"minecraft:scale"}].base 1000
