...
# mob
execute as @e[type=item_display,tag=maddons.sculk_spider,tag=maddons.entity,tag=!maddons.idle,tag=!maddons.death] at @s run function magical_addons:entity/sculk_spider/check
