...
## entity
execute at @a run execute as @e[tag=maddons.registered,distance=..16] at @s run function magical_addons:main/register
...
## player
execute as @a[tag=!maddons.aa,nbt={Inventory:[{components:{"minecraft:custom_data":{magical_addons:{mana_item:1}}}}]},scores={maddons.mana=199}] at @s run playsound magical_addons:ui.mana.recharge player @s ~ ~ ~ 10000
...
execute as @a[scores={maddons.mana=..399}] at @s run scoreboard players add @s maddons.mana 1
execute as @a[tag=!maddons.aa,scores={maddons.mana=201..}] at @s run scoreboard players set @s maddons.mana 200
...
## block
execute at @a as @e[type=item_display,tag=maddons.block,tag=!maddons.persistent,distance=..9] at @s run kill
execute at @a as @e[type=item_display,tag=maddons.persistent,distance=..16] at @s unless predicate magical_addons:block/placed run kill
...
execute store result score #maddons.entity_spawn maddons.stat if data storage maddons.main:registry data.entities
