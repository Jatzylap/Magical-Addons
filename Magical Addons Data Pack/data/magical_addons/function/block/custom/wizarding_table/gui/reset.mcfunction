...
item replace block ~ ~ ~ container.1 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.5 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.6 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.7 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.8 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.9 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.14 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.15 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.16 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1,result:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.10 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.17 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.18 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.19 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.23 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.24 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.25 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
item replace block ~ ~ ~ container.26 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]

execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.2 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.3 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.4 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.11 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.12 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.13 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.20 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.21 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
execute if entity @s[tag=maddons.wt_rb] run item replace block ~ ~ ~ container.22 with structure_void[max_stack_size=1,max_damage=100,tool={rules:[]},item_model="magical_addons:gui/wizarding_table",custom_data={magical_addons:{gui:1}},hide_tooltip={}]
