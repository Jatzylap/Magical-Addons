# block:custom/wizarding_table/gui/recipe_book/category6/set
# called by: block:custom/wizarding_table/gui/recipes

tag @s add maddons.wt_rb_cg6
tag @s remove maddons.wt_rb_cg1
tag @s remove maddons.wt_rb_cg2
tag @s remove maddons.wt_rb_cg3
