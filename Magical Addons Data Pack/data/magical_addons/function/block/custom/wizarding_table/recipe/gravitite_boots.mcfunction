# block:custom/wizarding_table/recipe/gravitite_boots
...
execute store success score @s maddons.craft if items block ~ ~ ~ container.2 *[custom_data~{magical_addons:{id:"gravitite"}}] \
											 ...
											 unless items block ~ ~ ~ container.22 * run loot replace block ~ ~ ~ container.16 loot magical_addons:gravitite_boots
...
execute store success score @s maddons.craft unless items block ~ ~ ~ container.2 * \
											 ...
											 unless items block ~ ~ ~ container.21 * \
											 if items block ~ ~ ~ container.22 *[custom_data~{magical_addons:{id:"gravitite"}}] run loot replace block ~ ~ ~ container.16 loot magical_addons:gravitite_boots
