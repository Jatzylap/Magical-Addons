...
## Block
execute summon item_display run data merge entity @s {data:{magical_addons:{id:"sparkstone",cmd:"execute unless block ~ ~ ~ spawner{components:{\"minecraft:custom_data\":{magical_addons:{id:sparkstone}}}} run function magical_addons:block/custom/sparkstone/break"}},transformation:{scale:[-1,1,-1]},Tags:[maddons.block,maddons.sparkstone],item:{id:spawner,components:{item_model:"magical_addons:sparkstone"}},view_range:64}
