...
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/block/place/cursed_head=true}] run function magical_addons:block/custom/cursed_head/scan"
