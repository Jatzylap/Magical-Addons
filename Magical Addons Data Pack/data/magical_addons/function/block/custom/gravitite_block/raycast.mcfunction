# block:custom/gravitite_block/raycast
# called by advancement: block:place/gravitite_block

data modify storage bs:data raycast.entities set value 0b
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/block/place/gravitite_block=true}] run function magical_addons:block/custom/gravitite_block/scan"
