...
## Part: foot
summon item_display ~ ~ ~ {item:{id:"spawner",components:{"minecraft:item_model":"air","minecraft:custom_data":{magical_addons:{id:"aether_portal",face:"north",part:"foot",cmd:"execute unless block ~ ~ ~ white_bed[facing=north,part=foot] run function magical_addons:block/custom/aether_portal/break"}}}},Tags:[maddons.block,maddons.aether_portal,maddons.invul,maddons.block.face_north,maddons.block.part_foot]}
