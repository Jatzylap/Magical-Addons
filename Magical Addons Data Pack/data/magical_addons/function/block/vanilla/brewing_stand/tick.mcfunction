...
execute if data block ~ ~ ~ {BrewTime:0s} if items block ~ ~ ~ container.* minecraft:potion[potion_contents={potion:"minecraft:regeneration"}] run advancement grant @p only magical_addons:brew_sparkstone_potion
...
execute if data block ~ ~ ~ {BrewTime:0s} if items block ~ ~ ~ container.* minecraft:splash_potion[potion_contents={potion:"minecraft:regeneration"}] run advancement grant @p only magical_addons:brew_sparkstone_potion
...
execute if data block ~ ~ ~ {BrewTime:0s} if items block ~ ~ ~ container.* minecraft:lingering_potion[potion_contents={potion:"minecraft:regeneration"}] run advancement grant @p only magical_addons:brew_sparkstone_potion
