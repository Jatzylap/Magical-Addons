...
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/block/place/brewing_stand=true}] run function magical_addons:block/vanilla/brewing_stand/scan"
