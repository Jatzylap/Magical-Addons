...
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/block/place/stone_slab=true}] run function magical_addons:block/vanilla/stone_slab/scan"
