...
## Block
summon item_display ~ ~ ~ {Tags:[maddons.block,maddons.vanilla,maddons.cullable,maddons.persistent,maddons.light,maddons.gold_ores],item:{id:"stick",count:1,components:{item_model:"air",custom_model_data:{colors:[I;16776960]},custom_data:{magical_addons:{id:"gold_ores",cmd:"execute unless block ~ ~ ~ #magical_addons:gold_ores run kill @n[type=item_display,tag=maddons.gold_ores,distance=...5]"}}}},item_display:"head",shadow_strength:0f}
