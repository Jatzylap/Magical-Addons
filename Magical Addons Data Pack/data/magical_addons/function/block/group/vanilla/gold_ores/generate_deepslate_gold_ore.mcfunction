# block:group/vanilla/gold_ores/generate_deepslate_gold_ore
# called by: dimension:*/worldgen/set_blocks

summon item_display ~ ~ ~ {data:{magical_addons:{id:"gold_ores",cmd:"execute unless block ~ ~ ~ #magical_addons:gold_ores run kill @n[type=item_display,tag=maddons.gold_ores,distance=...5]"}},Tags:[maddons.block,maddons.vanilla,maddons.cullable,maddons.light,maddons.gold_ores,maddons.block.unloadable],item:{id:"stick",count:1,components:{item_model:"air",custom_model_data:{colors:[I;16776960]}}},item_display:"head"}
