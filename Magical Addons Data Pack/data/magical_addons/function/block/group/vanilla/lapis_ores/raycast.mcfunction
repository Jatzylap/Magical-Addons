# block:group/vanilla/lapis_ores/raycast
# called by advancement: block:place/lapis_ores

data modify storage bs:data raycast.entities set value 0b
data modify storage bs:data raycast.on_targeted_block set value "execute as @p[advancements={magical_addons:---/block/place/lapis_ores=true}] run function magical_addons:block/group/vanilla/lapis_ores/scan"
