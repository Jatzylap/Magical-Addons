...
## Block
summon item_display ~ ~ ~ {data:{magical_addons:{id:"emerald_ores",cmd:"execute unless block ~ ~ ~ #emerald_ores run kill @n[type=item_display,tag=maddons.emerald_ores,distance=...5]"}},Tags:[maddons.block,maddons.vanilla,maddons.cullable,maddons.light,maddons.emerald_ores],item:{id:"stick",count:1,components:{item_model:"air",custom_model_data:{colors:[I;65280]}}},item_display:"head",shadow_strength:0f}
