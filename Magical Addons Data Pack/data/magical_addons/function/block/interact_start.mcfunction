...
## Set
data modify storage iris:args command set value "execute align xyz positioned ~.5 ~.5 ~.5 run function magical_addons:block/interact"
...
## Save
execute anchored eyes positioned ^ ^ ^ run function magical_addons:block/interact_save with storage iris:output
