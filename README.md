...
Magical Addons is a data pack for Minecraft: Java Edition which allows players to craft magic tools, fight new mobs and explore new dimensions that seamlessly mesh with the base game.
