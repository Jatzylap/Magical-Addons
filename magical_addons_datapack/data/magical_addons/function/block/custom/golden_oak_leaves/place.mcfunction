...
## Block
execute summon item_display run data merge entity @s {transformation:{scale:[-1,1,-1]},Rotation:[0f,0f],item_display:"head",item:{id:"spawner",components:{"minecraft:item_model":"magical_addons:golden_oak_leaves","minecraft:custom_data":{magical_addons:{properties:{persistent:1b,tree:"skyroot"},id:"golden_oak_leaves",cmd:"execute unless block ~ ~ ~ spawner{components:{\"minecraft:custom_data\":{magical_addons:{id:golden_oak_leaves}}}} run function magical_addons:block/custom/golden_oak_leaves/break"}}}},view_range:64,Tags:[maddons.block,maddons.golden_oak_leaves,maddons.block.leaves]}
