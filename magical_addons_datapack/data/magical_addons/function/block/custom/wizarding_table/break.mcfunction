...
kill @e[type=item,nbt={Item:{id:"minecraft:barrel",components:{"minecraft:custom_name":'{"extra":[{"translate":"item.magical_addons.wizarding_table"}],"italic":false,"text":""}'}}},distance=..1]
kill @e[type=item,nbt={Item:{id:"minecraft:brown_shulker_box",components:{"minecraft:custom_name":'{"extra":[{"translate":"item.magical_addons.wizarding_table"}],"italic":false,"text":""}'}}},distance=..1]
