...
execute if entity @s[tag=maddons.wt_rb_cg3] if score @s maddons.wizarding_table_page matches 2..3 run data modify block ~ ~ ~ Items[{Slot:0b}].components."minecraft:custom_model_data".strings[0] set value "wt_rb_cg3_s0"
...
execute if entity @s[tag=maddons.wt_rb_cg3] if score @s maddons.wizarding_table_page matches 4 run data modify block ~ ~ ~ Items[{Slot:0b}].components."minecraft:custom_model_data".strings[0] set value "wt_rb_cg3_s1"
