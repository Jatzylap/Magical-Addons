...
execute unless data block ~ ~ ~ Items[{Slot:11b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run tag @s[tag=maddons.wt_rb_cg3] add maddons.wt_rb_cg_r
execute unless data block ~ ~ ~ Items[{Slot:12b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run tag @s[tag=maddons.wt_rb_cg4] add maddons.wt_rb_cg_r
execute unless data block ~ ~ ~ Items[{Slot:20b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run tag @s[tag=maddons.wt_rb_cg5] add maddons.wt_rb_cg_r
execute unless data block ~ ~ ~ Items[{Slot:21b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run tag @s[tag=maddons.wt_rb_cg6] add maddons.wt_rb_cg_r
...
execute at @s[tag=maddons.wt_rb,tag=!maddons.wt_rb_cg_r] if score @s maddons.wizarding_table_page matches 0.. unless data block ~ ~ ~ Items[{Slot:11b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run function magical_addons:block/custom/wizarding_table/gui/recipe_book/category3/set
execute at @s[tag=maddons.wt_rb,tag=!maddons.wt_rb_cg_r] if score @s maddons.wizarding_table_page matches 0.. unless data block ~ ~ ~ Items[{Slot:12b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run function magical_addons:block/custom/wizarding_table/gui/recipe_book/category4/set
execute at @s[tag=maddons.wt_rb,tag=!maddons.wt_rb_cg_r] if score @s maddons.wizarding_table_page matches 0.. unless data block ~ ~ ~ Items[{Slot:20b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run function magical_addons:block/custom/wizarding_table/gui/recipe_book/category5/set
execute at @s[tag=maddons.wt_rb,tag=!maddons.wt_rb_cg_r] if score @s maddons.wizarding_table_page matches 0.. unless data block ~ ~ ~ Items[{Slot:21b,components:{"minecraft:custom_data":{magical_addons:{gui:1}}}}] run function magical_addons:block/custom/wizarding_table/gui/recipe_book/category6/set
