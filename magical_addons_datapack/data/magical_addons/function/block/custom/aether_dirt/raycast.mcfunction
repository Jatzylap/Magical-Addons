# block:custom/aether_dirt/raycast
...
## Set
data modify storage iris:args command set value "execute align xyz positioned ~.5 ~.5 ~.5 run function magical_addons:block/custom/aether_dirt/scan"
