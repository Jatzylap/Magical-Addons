...
execute at @s[tag=maddons.wizarding_table] as @e[distance=..1,nbt={Age:0s},type=item] at @s unless data entity @s Thrower run function magical_addons:block/custom/wizarding_table/loot
