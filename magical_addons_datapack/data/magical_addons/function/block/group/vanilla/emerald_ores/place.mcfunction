...
## Block
summon item_display ~ ~ ~ {Tags:[maddons.block,maddons.vanilla,maddons.cullable,maddons.persistent,maddons.light,maddons.emerald_ores],item:{id:"stick",count:1,components:{item_model:"air",custom_model_data:{colors:[I;65280]},custom_data:{magical_addons:{id:"emerald_ores",cmd:"execute unless block ~ ~ ~ #emerald_ores run kill @n[type=item_display,tag=maddons.emerald_ores,distance=...5]"}}}},item_display:"head",shadow_strength:0f}
