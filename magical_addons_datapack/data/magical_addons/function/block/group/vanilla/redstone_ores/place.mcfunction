...
## Block
summon item_display ~ ~ ~ {Tags:[maddons.block,maddons.vanilla,maddons.cullable,maddons.persistent,maddons.light,maddons.redstone_ores],item:{id:"stick",count:1,components:{item_model:"air",custom_model_data:{colors:[I;16711680]},custom_data:{magical_addons:{id:"redstone_ores",cmd:"execute unless block ~ ~ ~ #redstone_ores run kill @n[type=item_display,tag=maddons.redstone_ores,distance=...5]"}}}},item_display:"head"}
