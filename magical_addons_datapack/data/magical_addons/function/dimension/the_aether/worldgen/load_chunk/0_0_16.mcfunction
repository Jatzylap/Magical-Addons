...
execute store result storage maddons.dimension:the_aether data.player.new_chunk.y int 1 run scoreboard players operation @s maddons.chunk.y_ += #0 maddons.constant
