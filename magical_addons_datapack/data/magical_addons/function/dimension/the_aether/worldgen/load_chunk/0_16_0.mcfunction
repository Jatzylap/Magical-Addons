...
execute store result storage maddons.dimension:the_aether data.player.new_chunk.x int 1 run scoreboard players operation @s maddons.chunk.x_ += #0 maddons.constant
...
execute store result storage maddons.dimension:the_aether data.player.new_chunk.z int 1 run scoreboard players operation @s maddons.chunk.z_ += #0 maddons.constant
