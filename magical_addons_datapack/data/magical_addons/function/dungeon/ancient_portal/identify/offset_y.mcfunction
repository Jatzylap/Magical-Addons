...
execute unless score @s maddons.temp matches ..-23 positioned ~ ~-1 ~ unless block ~ ~ ~ chiseled_bookshelf{components:{"minecraft:custom_data":{magical_addons:{id:"sparkstone"}}}} run function magical_addons:dungeon/ancient_portal/identify/offset_y