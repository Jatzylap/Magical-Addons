...
execute if score @s maddons.portal_time_check matches 0 if score @s maddons.portal_overlay matches 1.. if items entity @s armor.head *[minecraft:item_model="air"] run item replace entity @s armor.head with air
#execute if score @s maddons.portal_time_check matches 0 if score @s maddons.portal_overlay matches 1.. if items entity @s armor.head *[!minecraft:item_model="air",equippable={camera_overlay:""}] run item modify entity @s armor.head with air
...
#execute if score @s maddons.portal_time matches 1.. in the_echo run forceload add ~-6 ~-6 ~6 ~6
#execute if score @s maddons.portal_time matches 1.. in overworld run forceload add ~-6 ~-6 ~6 ~6
execute if score @s maddons.portal_time matches 1.. in the_echo run forceload add ~ ~
execute if score @s maddons.portal_time matches 1.. in overworld run forceload add ~ ~
...
## Warp to Echo
execute unless dimension the_echo if score @s maddons.portal_time_check matches 1 if score @s maddons.portal_time matches 4 run function magical_addons:dungeon/ancient_portal/warp

## Return from Echo
execute if dimension the_echo if score @s maddons.portal_time_check matches 1 if score @s maddons.portal_time matches 4 run function magical_addons:dungeon/ancient_portal/return