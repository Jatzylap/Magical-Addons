# entity:angry_chicken/anger
# called by advancement: entity:hit_angry_chicken

execute as @e[distance=..12,type=chicken,tag=!maddons.angry_chicken] at @s run scoreboard players add @s maddons.angry_chicken 300
...
execute as @e[distance=..12,type=chicken,tag=maddons.angry_chicken,tag=!maddons.registered] at @s run function magical_addons:dev/register_entity {id:"angry_chicken",cmd:"function magical_addons:entity/angry_chicken/loop"}
