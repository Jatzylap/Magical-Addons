...
execute if score @s maddons.angry_chicken matches ..0 run function magical_addons:entity/angry_chicken/forget
#execute if entity @s[tag=maddons.stunned] run function magical_addons:entity/angry_chicken/forget