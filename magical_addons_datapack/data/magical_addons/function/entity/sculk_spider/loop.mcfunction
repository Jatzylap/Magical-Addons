...
execute as @s[tag=maddons.ceiling,tag=!maddons.death] run function magical_addons:entity/sculk_spider/invert_facing
execute as @s[tag=!maddons.ceiling,tag=!maddons.death] run function magical_addons:entity/sculk_spider/facing
