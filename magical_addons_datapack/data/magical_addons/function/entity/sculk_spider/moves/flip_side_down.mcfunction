...
execute if entity @s[tag=!maddons.side_down] run data merge entity @s[tag=maddons.body] {start_interpolation:-1,interpolation_duration:20,transformation:{left_rotation:[.695f,0f,0f,.719f]}}
execute if entity @s[tag=!maddons.side_down] on passengers run data merge entity @s[tag=maddons.head] {start_interpolation:-1,interpolation_duration:20,transformation:{left_rotation:[.695f,0f,0f,.719f]}}

tag @s[tag=!maddons.side_down] add maddons.flip
