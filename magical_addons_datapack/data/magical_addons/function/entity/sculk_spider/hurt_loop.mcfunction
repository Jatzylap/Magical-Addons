...
execute if score @s maddons.damage matches 10 on passengers run data modify entity @s[tag=maddons.head] item.components."minecraft:custom_model_data".strings[0] set value "normal"
execute if score @s maddons.damage matches 10 run data modify entity @s[tag=maddons.body] item.components."minecraft:custom_model_data".strings[0] set value "normal"
