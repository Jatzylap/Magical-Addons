...
## Set cooldown frame
scoreboard players set @s maddons.cooldown 40

## Set animation
execute on passengers store result entity @s[tag=maddons.head] item.components."minecraft:custom_model_data".floats[1] float 1 on vehicle run data modify entity @s item.components."minecraft:custom_model_data".floats[1] set value 4f
data modify entity @s item.components."minecraft:custom_data".magical_addons merge value {attack:"swing1"}
...
scoreboard players operation @s maddons.animation %= #40 maddons.constant
