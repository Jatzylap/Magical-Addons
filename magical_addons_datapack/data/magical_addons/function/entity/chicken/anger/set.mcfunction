...
execute as @e[distance=..12,type=chicken,tag=maddons.chicken.anger,tag=!maddons.registered] at @s run function magical_addons:dev/register_entity {id:"chicken",cmd:"function magical_addons:entity/chicken/anger/loop"}
