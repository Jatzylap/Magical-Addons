...
## Offhand wand
execute unless data entity @s {SelectedItem:{components:{"minecraft:custom_data":{magical_addons:{wand:1}}}}} if data entity @s {Inventory:[{Slot:-106b,components:{"minecraft:custom_data":{magical_addons:{wand:1}}}}]} run function magical_addons:item/wand/use_offhand with entity @s Inventory[{Slot:-106b}].components."minecraft:custom_data".magical_addons

## Mainhand wand
execute if data entity @s {SelectedItem:{components:{"minecraft:custom_data":{magical_addons:{wand:1}}}}} run function magical_addons:item/wand/use_mainhand with entity @s SelectedItem.components."minecraft:custom_data".magical_addons
