...
execute if entity @s[tag=!maddons.no_break] unless data entity @s {item:{components:{"minecraft:damage":2031}}} run loot spawn ~ ~ ~ loot magical_addons:netherite_dagger
execute if entity @s[tag=!maddons.no_break] unless data entity @s {item:{components:{"minecraft:damage":2031}}} run item replace entity @n[type=item,dy=1,nbt={Age:0s}] contents from entity @s contents magical_addons:item/damage/netherite_dagger
...
particle minecraft:item{item:{id:"snowball",components:{item_model:"magical_addons:netherite_dagger"}}} ~ ~.1 ~ 0 0 0 .1 9
