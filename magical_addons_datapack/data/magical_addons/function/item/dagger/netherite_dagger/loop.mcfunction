# item:dagger/netherite_dagger/tick
# called by: <dev>
...
execute unless predicate magical_addons:shared/riding_vehicle run function magical_addons:item/dagger/netherite_dagger/break