# item:dagger/wooden_dagger/shoot
...
execute as @n[tag=maddons.wooden_dagger] run function magical_addons:dev/register_entity {id:"wooden_dagger",cmd:"function magical_addons:item/dagger/wooden_dagger/loop"}
