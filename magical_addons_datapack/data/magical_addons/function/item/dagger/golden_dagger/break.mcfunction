...
execute if entity @s[tag=!maddons.no_break] run loot spawn ~ ~ ~ loot magical_addons:items/golden_dagger
execute if entity @s[tag=!maddons.no_break] run item replace entity @n[type=item,dy=1,nbt={Age:0s}] contents from entity @s contents magical_addons:item/damage/golden_dagger
