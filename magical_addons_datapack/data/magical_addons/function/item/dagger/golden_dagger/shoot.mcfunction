# item:dagger/golden_dagger/shoot
...
execute as @n[tag=maddons.golden_dagger] run function magical_addons:dev/register_entity {id:"golden_dagger",cmd:"function magical_addons:item/dagger/golden_dagger/loop"}
