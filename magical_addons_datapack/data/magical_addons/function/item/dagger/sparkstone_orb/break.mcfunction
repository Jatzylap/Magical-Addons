# item:dagger/sparkstone_orb/break
# called by: item:dagger/sparkstone_orb/loop
...
execute if data entity @s {item:{components:{"minecraft:damage":50}}} run function magical_addons:item/dagger/sparkstone_orb/explode
