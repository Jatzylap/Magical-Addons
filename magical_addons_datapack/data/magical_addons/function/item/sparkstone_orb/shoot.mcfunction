...
execute on passengers run data merge entity @s {Tags:[maddons.entity,maddons.sparkstone_orb,maddons.invul],billboard:"center",view_range:300f,transformation:{scale:[0.55f,0.55f,0.55f]},teleport_duration:2}
execute on passengers run function magical_addons:dev/register_entity {id:"sparkstone_orb",cmd:"function magical_addons:item/sparkstone_orb/loop"}
