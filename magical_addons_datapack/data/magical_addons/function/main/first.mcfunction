...
## Pack installed
execute as @a[tag=!magical_addons] at @s unless dimension the_echo run playsound magical_addons:ui.pack.title master @s ~ ~ ~ 10000
execute as @a[tag=!magical_addons] at @s if dimension the_echo run playsound magical_addons:ui.pack.title player @s ~ ~ ~ 10000
