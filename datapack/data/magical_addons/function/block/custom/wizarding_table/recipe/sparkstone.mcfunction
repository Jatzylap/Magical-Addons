# block:custom/wizarding_table/recipe/sparkstone
...
execute store success score @s maddons.craft if items block ~ ~ ~ container.2 *[custom_data~{magical_addons:{id:"sparkstone_shard"}}] \
											 ...
											 if items block ~ ~ ~ container.13 *[custom_data~{magical_addons:{id:"sparkstone_shard"}}] \
											 if items block ~ ~ ~ container.20 *[custom_data~{magical_addons:{id:"sparkstone_shard"}}] \
											 if items block ~ ~ ~ container.21 *[custom_data~{magical_addons:{id:"sparkstone_shard"}}] \
											 if items block ~ ~ ~ container.22 *[custom_data~{magical_addons:{id:"sparkstone_shard"}}] run loot replace block ~ ~ ~ container.16 loot magical_addons:sparkstone
