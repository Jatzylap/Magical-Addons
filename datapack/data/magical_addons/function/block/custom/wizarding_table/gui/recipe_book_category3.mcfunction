# block:custom/wizarding_table/gui/recipe_book_category3
...
execute if entity @s[tag=maddons.block.rb.c3_] unless data block ~ ~ ~ {Items:[{Slot:26b}]} unless score @s maddons.wizarding_table_page matches 2.. run playsound ui.button.click ui @p ~ ~ ~ .3

## Scroll
execute if entity @s[tag=maddons.block.rb.c3_] unless data block ~ ~ ~ {Items:[{Slot:8b}]} unless score @s maddons.wizarding_table_page matches ..0 run scoreboard players remove @s maddons.wizarding_table_page 1
execute if entity @s[tag=maddons.block.rb.c3_] unless data block ~ ~ ~ {Items:[{Slot:26b}]} unless score @s maddons.wizarding_table_page matches 2.. run scoreboard players add @s maddons.wizarding_table_page 1
...
## Category pages
execute if score @s maddons.wizarding_table_page matches 0 run item replace block ~ ~ ~ container.0 with structure_void[max_stack_size=1,max_damage=100,item_model="magical_addons:gui/wizarding_table",custom_model_data={strings:["wt_rb_cg3_s2"]},custom_data={magical_addons:{gui:1}},tooltip_display={hide_tooltip:true}]
execute if score @s maddons.wizarding_table_page matches 1 run item replace block ~ ~ ~ container.0 with structure_void[max_stack_size=1,max_damage=100,item_model="magical_addons:gui/wizarding_table",custom_model_data={strings:["wt_rb_cg3_s0"]},custom_data={magical_addons:{gui:1}},tooltip_display={hide_tooltip:true}]
execute if score @s maddons.wizarding_table_page matches 2 run item replace block ~ ~ ~ container.0 with structure_void[max_stack_size=1,max_damage=100,item_model="magical_addons:gui/wizarding_table",custom_model_data={strings:["wt_rb_cg3_s1"]},custom_data={magical_addons:{gui:1}},tooltip_display={hide_tooltip:true}]
...
tag @s add maddons.block.rb.c3_