...
execute unless block ~ ~-1 ~ #magical_addons:non_collidable if entity @s[tag=maddons.phase1] run summon item_display ~ ~ ~ {data:{magical_addons:{tick_cmd:"function magical_addons:entity/automaton/effects/swing2_spell"}},CustomName:'{"translate":"entity.magical_addons.automaton"}',teleport_duration:2,Tags:[maddons.entity.tickable,maddons.magic,maddons.invul,maddons.automaton.swing2_spell,spell1],Passengers:[{Count:1,id:area_effect_cloud,Radius:0f,Duration:40}]}
execute unless block ~ ~-1 ~ #magical_addons:non_collidable if entity @s[tag=!maddons.phase1] run summon item_display ~ ~ ~ {data:{magical_addons:{tick_cmd:"function magical_addons:entity/automaton/effects/swing2_spell"}},CustomName:'{"translate":"entity.magical_addons.automaton"}',teleport_duration:2,Tags:[maddons.entity.tickable,maddons.magic,maddons.invul,maddons.automaton.swing2_spell,spell2],Passengers:[{Count:1,id:area_effect_cloud,Radius:0f,Duration:40}]}
