...
summon falling_block ^ ^4 ^.5 {Tags:[maddons.automaton.block],BlockState:{Name:"end_portal_frame",Properties:{eye:true}},DropItem:0,Time:0}
...
summon falling_block ^ ^6 ^ {Tags:[maddons.automaton.block],BlockState:{Name:"sculk_shrieker"},DropItem:0,Time:0}
summon falling_block ^2 ^ ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"dark_oak_fence"},DropItem:0,Time:0}
summon falling_block ^2 ^1 ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"dark_oak_fence"},DropItem:0,Time:0}
summon falling_block ^2 ^3 ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"dark_oak_fence"},DropItem:0,Time:0}
summon falling_block ^2 ^4 ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"dark_oak_fence"},DropItem:0,Time:0}
summon falling_block ^2 ^5 ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"dark_oak_fence"},DropItem:0,Time:0}
summon falling_block ^2 ^6 ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"anvil"},DropItem:0,Time:0}
summon falling_block ^2 ^7 ^1 {Tags:[maddons.automaton.block],BlockState:{Name:"sculk_catalyst"},DropItem:0,Time:0}
