...
execute as @a at @s if dimension the_aether unless entity @e[distance=..64,tag=maddons.automaton,tag=maddons.entity,type=item_display] run effect give @s darkness 1 0 true
